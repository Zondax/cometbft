...
require (
	github.com/cosmos/crypto-provider v0.0.0-00010101000000-000000000000
...
replace github.com/cosmos/crypto-provider => github.com/cosmos/crypto/crypto-provider v0.0.0-20241125123505-6a4780e75252
